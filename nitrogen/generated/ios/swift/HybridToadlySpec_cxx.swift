 ...
 */
open class HybridToadlySpec_cxx {
  /**
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_HybridToadlySpec_
   ...
   * The C++ part is a `std::shared_ptr<HybridToadlySpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_HybridToadlySpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_HybridToadlySpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_HybridToadlySpec_(newCxxPart)
      return newCxxPart
    }
  }
   ...
   */
  @inline(__always)
  public func equals(other: HybridToadlySpec_cxx) -> Bool {
  ...
  public final func createIssueWithTitle(title: std.string, reportType: bridge.std__optional_std__string_) -> bridge.Result_void_ {
    do {
      try self.__implementation.createIssueWithTitle(title: String(title), reportType: { () -> String? in
        if bridge.has_value_std__optional_std__string_(reportType) {
          let __unwrapped = bridge.get_std__optional_std__string_(reportType)
